...
export function CreateAddModal() {
    ...
    return (
        <Dialog.Portal>
          ...
          -translate-x-1/2 -translate-y-1/2 rounded-lg w-[500px] shadow-lg shadow-black/25">
                ...
                <form onSubmit={handleCreateAdd} className="mt-8 flex flex-col gap-4">
                    ...
                    <div className=" flex flex-col gap-2">
                        ...
                        <Input name="name" id="name" type="text" placeholder="Como te chamam dentro de jogo?" />
                    </div>
                    ...
                    <div className="flex gap-6">
                        ...
                        <div className="flex flex-col gap-1">
                            <label htmlFor="game">Qual horário do dia?</label>
